...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Se traen las operaciones de un array de Strings
    ...
    public boolean validar(){
        ...
        if (num1.getText().toString().isEmpty()){
            num1.setError(getString(R.string.mensaje_eror_numero_uno));
            num1.requestFocus();
            return false;
        }
        if (num2.getText().toString().isEmpty()){
            num2.setError(getString(R.string.mensaje_eror_numero_dos));
            num2.requestFocus();
            return false;
        }
        ...
        if(n2 == 0 && op == 3){
            num2.setError(getString(R.string.mensaje_error_div_cero));
            num2.requestFocus();
            return false;
        }
        return true;
